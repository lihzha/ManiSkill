...
from mani_skill.utils.scene_builder.table import CustomTableSceneBuilder
from mani_skill.utils.structs import Pose
from mani_skill.utils.structs.types import Array, GPUMemoryConfig, SimConfig


@register_env("CustomPushCube-v1", max_episode_steps=50)
class CustomPushCubeEnv(BaseEnv):
    """
    Task Description
    ----------------
