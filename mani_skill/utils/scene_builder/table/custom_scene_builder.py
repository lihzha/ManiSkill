...
class CustomTableSceneBuilder(SceneBuilder):
    def build(self):
        ...
        table_model_file = str(model_dir / "custom_table.obj")
        
        # table_model_file = "/home/irom-lab/projects/ManiSkill/mani_skill/assets/robots/trifinger/objects/meshes/ball.obj"
        scale = 1.75
...
if __name__ == '__main__':
    ...
    a = TableSceneBuilder("PushCube-v1")